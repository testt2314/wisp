...
Now with dual-engine support: faster-whisper and whisper-mps.
...
CONFIG = {
    ...
    "model_size": "large-v3",  # Used by whisper-mps
    "chunk_length_s": 30,
    "vad_threshold": 0.02,
    "chunk_duration": 20.0,
    ...
    "use_faster_whisper": True,  # The key setting to switch between engines
...
Enhanced Features:
  ...
  🔍 Spectral analysis for speech vs silence  
  ⏱️  Precise timestamp validation
  🚫 Background noise filtering
  🔗 Smart segment merging
  ✂️  Automatic silence removal
  🎵 MP3 audio boosting for better transcription
  🌐 Japanese to English translation (Kotoba models with faster-whisper)
        """
    )
...
def main():
    ...
    try:
        ...
        print("   • For whisper-mps, ensure you have the correct package: pip install -U openai-whisper")
        print("   • For faster-whisper, ensure you have: pip install faster-whisper")
